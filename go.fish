...
# bug
complete -c go -n __fish_use_subcommand -a bug -d 'start a bug report'
...
complete -c go -n '__fish_seen_subcommand_from help' -xa work -d "workspace maintenance"
complete -c go -n '__fish_seen_subcommand_from help' -xa run -d "compile and run Go program"
complete -c go -n '__fish_seen_subcommand_from help' -xa telemetry -d "manage telemetry data and settings"
...
complete -c go -n '__fish_seen_subcommand_from help' -xa buildconstraint -d "build constraints"
complete -c go -n '__fish_seen_subcommand_from help' -xa buildjson -d "build -json encoding"
...
complete -c go -n '__fish_seen_subcommand_from help' -xa goauth -d "GOAUTH environment variable"
...
complete -c go -n '__fish_seen_subcommand_from help' -xa private -d "configuration for downloading non-public code"
...
complete -c go -n '__fish_seen_subcommand_from help' -xa vcs -d "controlling version control with GOVCS"
...
# work
complete -c go -n __fish_use_subcommand -a work -d 'workspace maintenance'
complete -c go -f -n '__fish_seen_subcommand_from work' -a edit -d "edit go.work from tools or scripts"
complete -c go -f -n '__fish_seen_subcommand_from work' -a init -d "initialize workspace file"
complete -c go -f -n '__fish_seen_subcommand_from work' -a sync -d "sync workspace build list to modules"
complete -c go -f -n '__fish_seen_subcommand_from work' -a use -d "add modules to workspace file"

# telemetry
complete -c go -n __fish_use_subcommand -a telemetry -d 'manage telemetry data and settings'
complete -c go -f -n '__fish_seen_subcommand_from telemetry' -a on -d "enable telemetry uploading"
complete -c go -f -n '__fish_seen_subcommand_from telemetry' -a off -d "disable telemetry uploading"
complete -c go -f -n '__fish_seen_subcommand_from telemetry' -a local -d "enable local telemetry collection"
